...
namespace Learning_C_basics_App
{
    public static partial class Program
    {
        ...
        private static void Lesson_011()
        {
            ...
            // оператор switch - это конструкция, которая позволяет выполнить один из нескольких блоков кода
        ...
        private static void Lesson_012()
        {
            ...
            // цикл while - это конструкция, которая позволяет повторять блок кода до тех пор, пока условие истинно.
        ...
        private static void Lesson_013()
        {
            ...
            // цикл do while - это конструкция, которая позволяет повторять блок кода до тех пор, пока условие истинно,
            // но в отличие от цикла while, цикл do while гарантирует выполнение тела цикла хотя бы один раз,
        ...
        private static void Lesson_014()
        {
            ...
            // все 3 части цикла (инициализация, условие, итерация)
        ...
        { 
            ...
            // одномерный массив - это массив, который имеет одну размерность и представляет собой последовательность элементов,
            // которые могут быть доступны по индексу. Индексы в массиве начинаются с 0,
            // то есть первый элемент массива имеет индекс 0, второй элемент массива имеет индекс 1 и так далее.
