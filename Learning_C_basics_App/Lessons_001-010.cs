...
namespace Learning_C_basics_App
{
    public static partial class Program
    {
        ...
        public static void Lesson_004()
        {
            ...
            // Класс Convert предоставляет методы для конвертации базовых типов данных.
            // Например, Convert.ToInt32(string) конвертирует строку в целое число.
            string str1 = "5";
            string str2 = "2";
            ...
            // Так будет исключение FormatException (зависит от региональных настроек - что используется
        ...
        public static void Lesson_005()
        {
            ...
            // Parse - это статический метод, который принимает строку и пытается преобразовать её в указанный тип данных.
            // Если строка не может быть преобразована, метод Parse выбрасывает исключение FormatException.
            // TryParse - это статический метод, который также принимает строку
            // и пытается преобразовать её в указанный тип данных.
            // Однако, в отличие от Parse, TryParse не выбрасывает исключение при неудаче.
            // Вместо этого он возвращает логическое значение: true, если преобразование прошло успешно, и false, если нет.
            string str = "5";
        ...
        public static void Lesson_007()
        {
            ...
            // Инкремент (++) - это оператор, который увеличивает значение переменной на 1.
            // Декремент (--) - это оператор, который уменьшает значение переменной на 1.
            // Постфиксный инкремент (a++) возвращает текущее значение переменной, а затем увеличивает её на 1.
            // Префиксный инкремент (++a) сначала увеличивает значение переменной на 1, а затем возвращает новое значение.
            // Аналогично для декремента: a-- и --a.
            int a = 0;
        ...
        public static void Lesson_008()
        {
            ...
            // Операторы сравнения (операторы отношения) используются для сравнения двух значений
            // и возвращают логическое значение (true или false).
        ...
        public static void Lesson_009()
        {
            ...
            // if - это конструкция, которая позволяет выполнять определённый блок кода, если заданное условие истинно (true).
            // else - это конструкция, которая позволяет выполнять другой блок кода, если условие в if ложно (false).
            // if (условие)
